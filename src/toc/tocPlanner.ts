...
export function planToc(kind: TocKind): TocPlan {
  if (kind === "figures") return { kind, headingStyle: "TOC Heading", entryStyles: ["table of figures"], ooxml: `<w:p><w:pPr><w:pStyle w:val="TOC"/></w:pPr>${field(' TOC \\h \\z \\c "Figure" ')}</w:p>` };
  return { kind, headingStyle: "TOC Heading", entryStyles: ["toc 1", "toc 2"], ooxml: `<w:p><w:pPr><w:pStyle w:val="TOC"/></w:pPr>${field(' TOC \\o "1-3" \\h \\z \\u ')}</w:p>` };
}
